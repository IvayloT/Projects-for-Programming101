...
class Panda():
    ...
    def __str__(self):
        return "Panda name is {} and email {} and gender {}" \
...
class SocialNetwork:
    ...
    def are_friends(self, panda1, panda2):
        if panda1 not in self.network or padna2 not in self.network:
            return False
    ...
    def make_friends(self, panda1, panda2):
        if not self.has_panda(panda1):
            ...
            raise Exception("Pnadas are already friends")

    def panda_connection(self, panda):
        print(self.network)
        connection = {}
        q = []
        visited = set()
        ...
        while len(q) != 0:
            ...
            print(current_node)
            connection[current_node] = current_level
        ...
        def connection_levels(self, panda1, panda2):
            panda_table = self.panda_connection(panda1)
        ...
        def genders_in_network(self, level, gender, panda):
            panda_table = self.panda_connection(panda)
            counter = 0
...
#network2 = SocialNetwork.load("network.json")
# print(repr(network2))
